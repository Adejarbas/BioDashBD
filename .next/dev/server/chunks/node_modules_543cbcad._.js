...
__turbopack_context__.s([
    "base64url",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$util$2f$base64url$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
...
"[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parseSupabaseCookie(str) {
    ...
    try {
        ...
        const payload = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$util$2f$base64url$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__base64url$3e$__["base64url"].decode(payloadStr);
        const decoder = new TextDecoder();
...
"[project]/node_modules/set-cookie-parser/lib/set-cookie.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@supabase/auth-helpers-nextjs/dist/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var import_auth_helpers_shared = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [app-route] (ecmascript)");
var supabase;
function createClientComponentClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://scsldapnrzpjkyqkeiop.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNjc2xkYXBucnpwamt5cWtlaW9wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU1NTYyMzksImV4cCI6MjA3MTEzMjIzOX0.TxRPb6uaLdCCBdjvjKOghvaD7EBPlA2rZqTfh8gPdBw"), options, cookieOptions, isSingleton = true } = {}) {
...
var import_auth_helpers_shared2 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [app-route] (ecmascript)");
var import_set_cookie_parser = __turbopack_context__.r("[project]/node_modules/set-cookie-parser/lib/set-cookie.js [app-route] (ecmascript)");
...
function createPagesServerClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://scsldapnrzpjkyqkeiop.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNjc2xkYXBucnpwamt5cWtlaW9wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU1NTYyMzksImV4cCI6MjA3MTEzMjIzOX0.TxRPb6uaLdCCBdjvjKOghvaD7EBPlA2rZqTfh8gPdBw"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared3 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [app-route] (ecmascript)");
var import_set_cookie_parser2 = __turbopack_context__.r("[project]/node_modules/set-cookie-parser/lib/set-cookie.js [app-route] (ecmascript)");
...
function createMiddlewareClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://scsldapnrzpjkyqkeiop.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNjc2xkYXBucnpwamt5cWtlaW9wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU1NTYyMzksImV4cCI6MjA3MTEzMjIzOX0.TxRPb6uaLdCCBdjvjKOghvaD7EBPlA2rZqTfh8gPdBw"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared4 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [app-route] (ecmascript)");
...
function createServerComponentClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://scsldapnrzpjkyqkeiop.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNjc2xkYXBucnpwamt5cWtlaW9wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU1NTYyMzksImV4cCI6MjA3MTEzMjIzOX0.TxRPb6uaLdCCBdjvjKOghvaD7EBPlA2rZqTfh8gPdBw"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared5 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [app-route] (ecmascript)");
...
function createRouteHandlerClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://scsldapnrzpjkyqkeiop.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNjc2xkYXBucnpwamt5cWtlaW9wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU1NTYyMzksImV4cCI6MjA3MTEzMjIzOX0.TxRPb6uaLdCCBdjvjKOghvaD7EBPlA2rZqTfh8gPdBw"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://scsldapnrzpjkyqkeiop.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNjc2xkYXBucnpwamt5cWtlaW9wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU1NTYyMzksImV4cCI6MjA3MTEzMjIzOX0.TxRPb6uaLdCCBdjvjKOghvaD7EBPlA2rZqTfh8gPdBw"), options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://scsldapnrzpjkyqkeiop.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNjc2xkYXBucnpwamt5cWtlaW9wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU1NTYyMzksImV4cCI6MjA3MTEzMjIzOX0.TxRPb6uaLdCCBdjvjKOghvaD7EBPlA2rZqTfh8gPdBw"), options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://scsldapnrzpjkyqkeiop.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNjc2xkYXBucnpwamt5cWtlaW9wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU1NTYyMzksImV4cCI6MjA3MTEzMjIzOX0.TxRPb6uaLdCCBdjvjKOghvaD7EBPlA2rZqTfh8gPdBw"), options, cookieOptions } = {}) {
...
//# sourceMappingURL=node_modules_543cbcad._.js.map